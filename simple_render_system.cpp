...
namespace lve {
	...
	void SimpleRenderSystem::renderGameObjects(VkCommandBuffer commandBuffer, std::vector<LveGameObject>& gameObjects, const LveCamera& camera)
	{
		...
		//TODO: y and x axis rotation extrinsic while z axis intrinsic why?
		for (auto& obj : gameObjects) {
			...
			//obj.transform.rotation.y = glm::quarter_pi<float>();
			//obj.transform.rotation.x = glm::quarter_pi<float>();
			//obj.transform.rotation.z = glm::quarter_pi<float>();
